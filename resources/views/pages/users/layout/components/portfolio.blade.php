    ...
    <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
                <figure>
                    <img src="{{asset('template/assets/img/portfolio/app1.jpg')}}" class="img-fluid" alt="">
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-web">
            <div class="portfolio-wrap">
                <figure>
                    <img src="{{asset('template/assets/img/portfolio/web3.jpg')}}" class="img-fluid" alt="">
                    <a href="{{asset('template/assets/img/portfolio/web3.jpg')}}" class="link-preview venobox"
